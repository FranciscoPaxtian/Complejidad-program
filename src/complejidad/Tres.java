...
public class Tres extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, -1, -1));
        ...
        jLabel3.setText("Tercera forma");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, 220, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Numero de regiones");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 170, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("(Espacios encerrados entre nodos y aristas)");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 360, -1));

        Region.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(Region, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 110, 60, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 150, 30));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Resultado");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 190, 90, -1));

        Resultado.setBackground(new java.awt.Color(204, 204, 204));
        Resultado.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(Resultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 60, 40));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Tipo de codigo");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 240, 120, -1));

        Codigo.setBackground(new java.awt.Color(204, 204, 204));
        Codigo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        getContentPane().add(Codigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 270, 170, 50));
        ...
        getContentPane().add(BtAyuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 270, 50, 50));
    ...
    private void Proceso(){
        ...
        a = Integer.parseInt(Region.getText());
